...
CState_Destroyer_Battle_Idle::CState_Destroyer_Battle_Idle(CStateMachine* pMachine)
    : CState_Character(pMachine)
{
}

HRESULT CState_Destroyer_Battle_Idle::Initialize(const list<wstring>& AnimationList)
{
...
void CState_Destroyer_Battle_Idle::Enter_State(void* pArg)
{
...
void CState_Destroyer_Battle_Idle::Tick_State(_float fTimeDelta)
{
...
void CState_Destroyer_Battle_Idle::Exit_State()
{
    m_fAccReturnNuetral = 0.f;
}

void CState_Destroyer_Battle_Idle::Input(_float fTimeDelta)
{
...
CState_Destroyer_Battle_Idle* CState_Destroyer_Battle_Idle::Create(CStateMachine* pStateMachine, const list<wstring>& AnimationList)
{
    CState_Destroyer_Battle_Idle* pInstance = new CState_Destroyer_Battle_Idle(pStateMachine);
...
void CState_Destroyer_Battle_Idle::Free()
{
    __super::Free();
}
