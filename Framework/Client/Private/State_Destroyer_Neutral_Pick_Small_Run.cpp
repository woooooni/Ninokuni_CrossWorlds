...
CState_Destroyer_Neutral_Pick_Small_Run::CState_Destroyer_Neutral_Pick_Small_Run(CStateMachine* pMachine)
	: CState_Character(pMachine)
{
}

HRESULT CState_Destroyer_Neutral_Pick_Small_Run::Initialize(const list<wstring>& AnimationList)
{
...
void CState_Destroyer_Neutral_Pick_Small_Run::Enter_State(void* pArg)
{
	m_pCharacter->Disappear_Weapon();
	m_pModelCom->Set_Animation(m_AnimIndices[0]);
}

void CState_Destroyer_Neutral_Pick_Small_Run::Tick_State(_float fTimeDelta)
{
	Input(fTimeDelta);
}

void CState_Destroyer_Neutral_Pick_Small_Run::Exit_State()
{

}

void CState_Destroyer_Neutral_Pick_Small_Run::Input(_float fTimeDelta)
{
	_bool bMove = false;
	if (KEY_HOLD(KEY::W))
	{
...
CState_Destroyer_Neutral_Pick_Small_Run* CState_Destroyer_Neutral_Pick_Small_Run::Create(CStateMachine* pStateMachine, const list<wstring>& AnimationList)
{
	CState_Destroyer_Neutral_Pick_Small_Run* pInstance = new CState_Destroyer_Neutral_Pick_Small_Run(pStateMachine);

	if (FAILED(pInstance->Initialize(AnimationList)))
	{
		MSG_BOX("Fail Create : CState_Destroyer_Neutral_Pick_Small_Run");
...
void CState_Destroyer_Neutral_Pick_Small_Run::Free()
{
	__super::Free();
}
