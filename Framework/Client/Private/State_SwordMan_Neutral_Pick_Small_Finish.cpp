...
CState_SwordMan_Neutral_Pick_Small_Finish::CState_SwordMan_Neutral_Pick_Small_Finish(CStateMachine* pMachine)
    : CState_Character(pMachine)
{
}

HRESULT CState_SwordMan_Neutral_Pick_Small_Finish::Initialize(const list<wstring>& AnimationList)
{
...
CState_SwordMan_Neutral_Pick_Small_Finish* CState_SwordMan_Neutral_Pick_Small_Finish::Create(CStateMachine* pStateMachine, const list<wstring>& AnimationList)
{
    CState_SwordMan_Neutral_Pick_Small_Finish* pInstance = new CState_SwordMan_Neutral_Pick_Small_Finish(pStateMachine);

    if (FAILED(pInstance->Initialize(AnimationList)))
    {
        MSG_BOX("Fail Create : CState_SwordMan_Neutral_Pick_Small_Finish");
...
void CState_SwordMan_Neutral_Pick_Small_Finish::Free()
{
    __super::Free();
}
