...
HRESULT CHumanMSCrossFieldMerchant::Initialize(void* pArg)
{
	...
	m_pModelCom->Set_Animation(TEXT("SKM_HumanMSCrossfieldMerchant.ao|HumanMSCrossfieldMerchant_Stand"));
...
HRESULT CHumanMSCrossFieldMerchant::Render()
{
...
HRESULT CHumanMSCrossFieldMerchant::Ready_Components()
{
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_HumanMSCrossFieldMerchant"), TEXT("Com_Model"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
