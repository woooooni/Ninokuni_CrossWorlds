...
CState_Destroyer_Neutral_Walk::CState_Destroyer_Neutral_Walk(CStateMachine* pMachine)
    : CState_Character(pMachine)
{
}

HRESULT CState_Destroyer_Neutral_Walk::Initialize(const list<wstring>& AnimationList)
{
...
void CState_Destroyer_Neutral_Walk::Enter_State(void* pArg)
{
	m_pCharacter->Disappear_Weapon();
	m_pModelCom->Set_Animation(m_AnimIndices[0]);
}

void CState_Destroyer_Neutral_Walk::Tick_State(_float fTimeDelta)
{
    Input(fTimeDelta);
}

void CState_Destroyer_Neutral_Walk::Exit_State()
{

}

void CState_Destroyer_Neutral_Walk::Input(_float fTimeDelta)
{
...
CState_Destroyer_Neutral_Walk* CState_Destroyer_Neutral_Walk::Create(CStateMachine* pStateMachine, const list<wstring>& AnimationList)
{
    CState_Destroyer_Neutral_Walk* pInstance = new CState_Destroyer_Neutral_Walk(pStateMachine);

    if (FAILED(pInstance->Initialize(AnimationList)))
    {
        MSG_BOX("Fail Create : CState_Destroyer_Neutral_Walk");
...
void CState_Destroyer_Neutral_Walk::Free()
{
    __super::Free();
}
