...
HRESULT CEdellian::Initialize(void* pArg)
{
	...
	m_pModelCom->Set_Animation(TEXT("SKM_Edellian.ao|Edellian_CSWalk"));
...
HRESULT CEdellian::Ready_Components()
{
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_Edellian"), TEXT("Com_Model"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
