...
CUI_WeaponSection_Weapon::CUI_WeaponSection_Weapon(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, UI_WEAPONSLOT eType)
...
CUI_WeaponSection_Weapon* CUI_WeaponSection_Weapon::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, UI_WEAPONSLOT eType)
{
	CUI_WeaponSection_Weapon* pInstance = new CUI_WeaponSection_Weapon(pDevice, pContext, eType);
