...
CStelliaState_Rage2StartTurnOL::CStelliaState_Rage2StartTurnOL(CStateMachine* pStateMachine)
	: CStelliaState_Base(pStateMachine)
{
}

HRESULT CStelliaState_Rage2StartTurnOL::Initialize(const list<wstring>& AnimationList)
{
...
void CStelliaState_Rage2StartTurnOL::Enter_State(void* pArg)
{
...
void CStelliaState_Rage2StartTurnOL::Tick_State(_float fTimeDelta)
{
	...
	{
		m_pStateMachineCom->Change_State(CStellia::STELLIA_RAGE2START);
	}
}

void CStelliaState_Rage2StartTurnOL::Exit_State()
{
}

CStelliaState_Rage2StartTurnOL* CStelliaState_Rage2StartTurnOL::Create(CStateMachine* pStateMachine, const list<wstring>& AnimationList)
{
	CStelliaState_Rage2StartTurnOL* pInstance = new CStelliaState_Rage2StartTurnOL(pStateMachine);

	if (FAILED(pInstance->Initialize(AnimationList)))
	{
		MSG_BOX("Fail Create : CStelliaState_Rage2StartTurnOL");
...
void CStelliaState_Rage2StartTurnOL::Free()
{
	__super::Free();
}
