...
HRESULT CState_Character_Neutral_Pick_Large_Run::Initialize(const list<wstring>& AnimationList)
{
...
void CState_Character_Neutral_Pick_Large_Run::Enter_State(void* pArg)
{
...
void CState_Character_Neutral_Pick_Large_Run::Exit_State()
{

}

CState_Character_Neutral_Pick_Large_Run* CState_Character_Neutral_Pick_Large_Run::Create(CStateMachine* pStateMachine, const list<wstring>& AnimationList)
{
    CState_Character_Neutral_Pick_Large_Run* pInstance = new CState_Character_Neutral_Pick_Large_Run(pStateMachine);

    if (FAILED(pInstance->Initialize(AnimationList)))
    {
        MSG_BOX("Fail Create : CState_Character_Neutral_Pick_Large_Run");
...
void CState_Character_Neutral_Pick_Large_Run::Free()
{
    __super::Free();
}
