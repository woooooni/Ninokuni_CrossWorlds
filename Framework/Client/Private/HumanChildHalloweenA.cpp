...
HRESULT CHumanChildHalloweenA::Initialize(void* pArg)
{
	...
	m_pModelCom->Set_Animation(TEXT("SKM_HumanChildHalloweenA.ao|HumanChildHalloweenA_Stand"));
...
HRESULT CHumanChildHalloweenA::Render()
{
...
HRESULT CHumanChildHalloweenA::Ready_Components()
{
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_HumanChildHalloweenA"), TEXT("Com_Model"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
