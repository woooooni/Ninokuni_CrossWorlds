...
CState_Engineer_Neutral_Idle::CState_Engineer_Neutral_Idle(CStateMachine* pMachine)
    : CState_Character(pMachine)
{
}

HRESULT CState_Engineer_Neutral_Idle::Initialize(const list<wstring>& AnimationList)
{
...
void CState_Engineer_Neutral_Idle::Enter_State(void* pArg)
{
...
void CState_Engineer_Neutral_Idle::Tick_State(_float fTimeDelta)
{
...
void CState_Engineer_Neutral_Idle::Exit_State()
{
    m_fAccIdleMotion = 0.f;
    m_iCurrAnimIndex = 0;
}

void CState_Engineer_Neutral_Idle::Input(_float fTimeDelta)
{
...
CState_Engineer_Neutral_Idle* CState_Engineer_Neutral_Idle::Create(CStateMachine* pStateMachine, const list<wstring>& AnimationList)
{
    CState_Engineer_Neutral_Idle* pInstance = new CState_Engineer_Neutral_Idle(pStateMachine);

    if (FAILED(pInstance->Initialize(AnimationList)))
    {
        MSG_BOX("Fail Create : CState_Engineer_Neutral_Idle");
...
void CState_Engineer_Neutral_Idle::Free()
{
    __super::Free();
}
