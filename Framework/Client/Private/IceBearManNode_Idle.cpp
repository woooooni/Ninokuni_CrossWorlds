...
HRESULT CIceBearManNode_Idle::Initialize_Prototype(BTNODE_DESC* pDesc, CBehaviorTree* pBT, vector<wstring> vecAnimationName)
{
...
CIceBearManNode_Idle* CIceBearManNode_Idle::Create(BTNODE_DESC* pDesc, CBehaviorTree* pBT, vector<wstring> vecAnimationName)
{
