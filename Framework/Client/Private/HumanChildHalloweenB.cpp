...
HRESULT CHumanChildHalloweenB::Initialize(void* pArg)
{
	...
	m_pModelCom->Set_Animation(TEXT("SKM_HumanChildHalloweenB.ao|HumanChildHalloweenB_Stand"));
...
HRESULT CHumanChildHalloweenB::Render()
{
...
HRESULT CHumanChildHalloweenB::Ready_Components()
{
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_HumanChildHalloweenB"), TEXT("Com_Model"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
