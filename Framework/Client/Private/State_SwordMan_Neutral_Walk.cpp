...
HRESULT CState_SwordMan_Neutral_Walk::Initialize(const list<wstring>& AnimationList)
{
...
void CState_SwordMan_Neutral_Walk::Enter_State(void* pArg)
{
...
void CState_SwordMan_Neutral_Walk::Input(_float fTimeDelta)
{
	_bool bMove = false;
	if (KEY_HOLD(KEY::W))
	{
...
CState_SwordMan_Neutral_Walk* CState_SwordMan_Neutral_Walk::Create(CStateMachine* pStateMachine, const list<wstring>& AnimationList)
{
    CState_SwordMan_Neutral_Walk* pInstance = new CState_SwordMan_Neutral_Walk(pStateMachine);

    if (FAILED(pInstance->Initialize(AnimationList)))
    {
        MSG_BOX("Fail Create : CState_SwordMan_Neutral_Walk");
...
void CState_SwordMan_Neutral_Walk::Free()
{
    __super::Free();
}
