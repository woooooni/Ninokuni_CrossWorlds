...
CStelliaState_Rage1StartTurnOC::CStelliaState_Rage1StartTurnOC(CStateMachine* pStateMachine)
	: CStelliaState_Base(pStateMachine)
{
}

HRESULT CStelliaState_Rage1StartTurnOC::Initialize(const list<wstring>& AnimationList)
{
...
void CStelliaState_Rage1StartTurnOC::Enter_State(void* pArg)
{
...
void CStelliaState_Rage1StartTurnOC::Tick_State(_float fTimeDelta)
{
	...
	{
		m_pStateMachineCom->Change_State(CStellia::STELLIA_RAGE1START_JUMP);
	}
}

void CStelliaState_Rage1StartTurnOC::Exit_State()
{
}

CStelliaState_Rage1StartTurnOC* CStelliaState_Rage1StartTurnOC::Create(CStateMachine* pStateMachine, const list<wstring>& AnimationList)
{
	CStelliaState_Rage1StartTurnOC* pInstance = new CStelliaState_Rage1StartTurnOC(pStateMachine);

	if (FAILED(pInstance->Initialize(AnimationList)))
	{
		MSG_BOX("Fail Create : CStelliaState_Rage1StartTurnOC");
...
void CStelliaState_Rage1StartTurnOC::Free()
{
	__super::Free();
}
