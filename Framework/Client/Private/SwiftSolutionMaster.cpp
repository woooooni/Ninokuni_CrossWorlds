...
HRESULT CSwiftSolutionMaster::Ready_Components()
{
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_Ruslan"), TEXT("Com_Model"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
