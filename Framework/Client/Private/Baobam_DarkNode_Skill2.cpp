...
HRESULT CBaobam_DarkNode_Skill2::Initialize_Prototype(CMonsterBT::BT_MONSTERDESC* pDesc, CMonsterBT* pBT)
{
...
void CBaobam_DarkNode_Skill2::Start()
{
	...
	m_tBTMonsterDesc.pOwnerModel->Set_Animation(TEXT("SKM_Baobam_Darkness.ao|BaoBam_Skill02"));
...
CBaobam_DarkNode_Skill2* CBaobam_DarkNode_Skill2::Create(CMonsterBT::BT_MONSTERDESC* pDesc, CMonsterBT* pBT)
{
