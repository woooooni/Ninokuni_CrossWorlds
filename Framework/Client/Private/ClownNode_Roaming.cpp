...
CClownNode_Roaming::CClownNode_Roaming()
{
}
...
CBTNode::NODE_STATE CClownNode_Roaming::Tick(const _float& fTimeDelta)
{
	_float4 vPos;
	_float4 vDestPos;
...
CClownNode_Roaming* CClownNode_Roaming::Create(BTNODE_DESC* pDesc, CBehaviorTree* pBT, vector<_vector>* vecRoamingArea)
{
	...
	{
		MSG_BOX("Fail Create : CClownNode_Roaming");
