...
void CVfx_SwordMan_Skill_PerfectBlade::Tick(_float fTimeDelta)
{
	...
	// Wield 1
	else if (m_iCount == 1 && m_fTimeAcc > 0.7f)
	{
		/*
		...
		*/
		...
		(
			...
			GET_INSTANCE(CEffect_Manager)->Get_WorldMatrixEffect(XMLoadFloat4x4(&m_WorldMatrix), _float3(0.f, 1.f, 0.f), _float3(3.f, 3.f, 3.f), _float3(0.f, 0.f, 0.f)),
	...
	// Wield 2
	else if (m_iCount == 2 && m_fTimeAcc > 1.f)
	{
		GET_INSTANCE(CEffect_Manager)->Generate_Effect
		(
			TEXT("Effect_Swordman_Skill_Perfectblade_Trail_Basic_Right"),
			GET_INSTANCE(CEffect_Manager)->Get_WorldMatrixEffect(XMLoadFloat4x4(&m_WorldMatrix), _float3(0.f, 1.f, 0.f), _float3(2.7f, 2.7f, 2.7f), _float3(0.f, 0.f, 0.f)),
			nullptr
		);
	...
	// Wield 3
	else if (m_iCount == 3 && m_fTimeAcc > 1.3f)
	{
		GET_INSTANCE(CEffect_Manager)->Generate_Effect
		(
			TEXT("Effect_Swordman_Skill_Perfectblade_Trail_Basic_Left"),
			GET_INSTANCE(CEffect_Manager)->Get_WorldMatrixEffect(XMLoadFloat4x4(&m_WorldMatrix), _float3(0.f, 1.f, 0.f), _float3(2.9f, 2.9f, 2.9f), _float3(0.f, 0.f, 0.f)),
			nullptr
		);
	...
	// Wield 4
	else if (m_iCount == 4 && m_fTimeAcc > 1.7f)
	{
	    GET_INSTANCE(CEffect_Manager)->Generate_Effect
	    (
	    	TEXT("Effect_Swordman_Skill_Perfectblade_Trail_Basic_Right"),
	    	GET_INSTANCE(CEffect_Manager)->Get_WorldMatrixEffect(XMLoadFloat4x4(&m_WorldMatrix), _float3(0.f, 1.f, 0.f), _float3(2.6f, 2.6f, 2.6f), _float3(0.f, 0.f, 0.f)),
	    	nullptr
	    );
	...
	// Wield 5
	else if (m_iCount == 5 && m_fTimeAcc > 2.f)
	{
	    GET_INSTANCE(CEffect_Manager)->Generate_Effect
	    (
	    	TEXT("Effect_Swordman_Skill_Perfectblade_Trail_Basic_Left"),
	...
	// Wield 6 : Special
	else if (m_iCount == 6 && m_fTimeAcc > 2.3f)
	{
	    GET_INSTANCE(CEffect_Manager)->Generate_Effect
	    (
	    	TEXT("Effect_Swordman_Skill_Perfectblade_Trail_Basic_Right"),
	    	GET_INSTANCE(CEffect_Manager)->Get_WorldMatrixEffect(XMLoadFloat4x4(&m_WorldMatrix), _float3(0.f, 1.f, 0.f), _float3(4.f, 4.f, 4.f), _float3(0.f, 0.f, 0.f)),
	    	nullptr
	    );
	...
	// Fire 0
	else if (m_iCount == 7 && m_fTimeAcc > 2.4f)
	{
	    // 왼쪽 뒤
		_matrix WorldMatrix = XMLoadFloat4x4(&m_WorldMatrix);
		_vector vPositionOrigin = WorldMatrix.r[CTransform::STATE_POSITION];
	...
	// Fire 1
	else if (m_iCount == 8 && m_fTimeAcc > 2.6f)
	{
	    // 중심
		_matrix WorldMatrix = XMLoadFloat4x4(&m_WorldMatrix);
		_vector vPositionOrigin = WorldMatrix.r[CTransform::STATE_POSITION];
	...
	// Fire 2
	else if (m_iCount == 9 && m_fTimeAcc > 2.8f)
	{
	    // 오른쪽 뒤
		_matrix WorldMatrix = XMLoadFloat4x4(&m_WorldMatrix);
		_vector vPositionOrigin = WorldMatrix.r[CTransform::STATE_POSITION];
