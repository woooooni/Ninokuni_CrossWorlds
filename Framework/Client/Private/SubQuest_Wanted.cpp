...
HRESULT CSubQuest_Wanted::Initialize()
{
	...
	CSubQuestNode_Wanted03_2* pSubQuest_Wanted03_2 = CSubQuestNode_Wanted03_2::Create();
	...
	CSubQuestNode_Wanted09* pSubQuest_Wanted09 = CSubQuestNode_Wanted09::Create();
	CSubQuestNode_Wanted10* pSubQuest_Wanted10 = CSubQuestNode_Wanted10::Create();
	...
	m_pRootNode->Add_ChildNode(pSubQuest_Wanted03_2);
	...
	m_pRootNode->Add_ChildNode(pSubQuest_Wanted09);
	m_pRootNode->Add_ChildNode(pSubQuest_Wanted10);
