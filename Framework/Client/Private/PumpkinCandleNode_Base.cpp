...
CPumpkinCandleNode_Base::CPumpkinCandleNode_Base()
{
}

HRESULT CPumpkinCandleNode_Base::Initialize_Prototype(CMonsterBT::BT_MONSTERDESC* pDesc, CMonsterBT* pBT)
{
...
void CPumpkinCandleNode_Base::Start()
{
}

CBTNode::NODE_STATE CPumpkinCandleNode_Base::Tick(const _float& fTimeDelta)
{
	return NODE_STATE::NODE_RUNNING;
}

CBTNode::NODE_STATE CPumpkinCandleNode_Base::Atk_BehaviorTick(const wstring& strAnimName, _float fDestWaitTime, const _float& fTimeDelta)
{
	if (m_bIsSucces)
		return NODE_STATE::NODE_SUCCESS;

	if (m_tBTMonsterDesc.pOwnerModel->Is_Fix() && m_tBTMonsterDesc.pOwnerModel->Is_Finish() &&
		!m_bWait && m_tBTMonsterDesc.pOwnerModel->Get_CurrAnimation()->Get_AnimationName() == strAnimName)
	{
		m_bWait = true;
...
_bool CPumpkinCandleNode_Base::Behavior_Wait(_float fDestWaitTime, const _float& fTimeDelta)
{
...
void CPumpkinCandleNode_Base::Free()
{
}
