...
CState_Engineer_Neutral_Pick_Large_Run::CState_Engineer_Neutral_Pick_Large_Run(CStateMachine* pMachine)
    : CState_Character(pMachine)
{
}

HRESULT CState_Engineer_Neutral_Pick_Large_Run::Initialize(const list<wstring>& AnimationList)
{
...
void CState_Engineer_Neutral_Pick_Large_Run::Enter_State(void* pArg)
{
	m_pModelCom->Set_Animation(m_AnimIndices[0]);
}

void CState_Engineer_Neutral_Pick_Large_Run::Tick_State(_float fTimeDelta)
{
	Input(fTimeDelta);
}

void CState_Engineer_Neutral_Pick_Large_Run::Exit_State()
{

}

void CState_Engineer_Neutral_Pick_Large_Run::Input(_float fTimeDelta)
{
	_bool bMove = false;
	if (KEY_HOLD(KEY::W))
	{
...
CState_Engineer_Neutral_Pick_Large_Run* CState_Engineer_Neutral_Pick_Large_Run::Create(CStateMachine* pStateMachine, const list<wstring>& AnimationList)
{
    CState_Engineer_Neutral_Pick_Large_Run* pInstance = new CState_Engineer_Neutral_Pick_Large_Run(pStateMachine);

    if (FAILED(pInstance->Initialize(AnimationList)))
    {
        MSG_BOX("Fail Create : CState_Engineer_Neutral_Pick_Large_Run");
...
void CState_Engineer_Neutral_Pick_Large_Run::Free()
{
    __super::Free();
}
