...
HRESULT CVfx_Destroyer_Skill_HyperStrike::Initialize_Prototype()
{
	...
	{
		m_pFrameTriger[TYPE_ET1_P_SPARKLE] = 0;
	...
	{
		m_pFrameTriger[TYPE_ET2_D_SPARKLE] = 0;
		...
		m_pFrameTriger[TYPE_ET2_P_FIRES] = 0;
	...
	{
		m_pFrameTriger[TYPE_ET3_D_CIRCLE] = 0;
		m_pPositionOffset[TYPE_ET3_D_CIRCLE] = _float3(0.f, 0.f, 0.f);
		m_pScaleOffset[TYPE_ET3_D_CIRCLE] = _float3(5.f, 5.f, 5.f);
		m_pRotationOffset[TYPE_ET3_D_CIRCLE] = _float3(0.f, 0.f, 0.f);

		m_pFrameTriger[TYPE_ET3_D_CRACK] = 0;
		...
		m_pFrameTriger[TYPE_ET3_P_SPRINGUP] = 0;
		...
		m_pFrameTriger[TYPE_ET3_P_FIRES] = 0;
		...
		m_pFrameTriger[TYPE_ET3_P_SMOKE] = 0;
		...
		m_pFrameTriger[TYPE_ET3_E_STONECRACK] = 0;
