...
CState_SwordMan_Neutral_Crouch_Move::CState_SwordMan_Neutral_Crouch_Move(CStateMachine* pMachine)
    : CState_Character(pMachine)
{
}

HRESULT CState_SwordMan_Neutral_Crouch_Move::Initialize(const list<wstring>& AnimationList)
{
...
void CState_SwordMan_Neutral_Crouch_Move::Enter_State(void* pArg)
{
	m_pModelCom->Set_Animation(m_AnimIndices[0]);
}

void CState_SwordMan_Neutral_Crouch_Move::Tick_State(_float fTimeDelta)
{
    Input(fTimeDelta);
}

void CState_SwordMan_Neutral_Crouch_Move::Exit_State()
{

}

void CState_SwordMan_Neutral_Crouch_Move::Input(_float fTimeDelta)
{
	if (KEY_TAP(KEY::CTRL))
	{
...
CState_SwordMan_Neutral_Crouch_Move* CState_SwordMan_Neutral_Crouch_Move::Create(CStateMachine* pStateMachine, const list<wstring>& AnimationList)
{
    CState_SwordMan_Neutral_Crouch_Move* pInstance = new CState_SwordMan_Neutral_Crouch_Move(pStateMachine);

    if (FAILED(pInstance->Initialize(AnimationList)))
    {
        MSG_BOX("Fail Create : CState_SwordMan_Neutral_Crouch_Move");
...
void CState_SwordMan_Neutral_Crouch_Move::Free()
{
    __super::Free();
}
