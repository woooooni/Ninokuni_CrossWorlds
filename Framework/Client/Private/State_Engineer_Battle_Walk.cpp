...
CState_Engineer_Battle_Walk::CState_Engineer_Battle_Walk(CStateMachine* pMachine)
    : CState_Character(pMachine)
{
}

HRESULT CState_Engineer_Battle_Walk::Initialize(const list<wstring>& AnimationList)
{
...
void CState_Engineer_Battle_Walk::Enter_State(void* pArg)
{
	m_pModelCom->Set_Animation(m_AnimIndices[0]);
}

void CState_Engineer_Battle_Walk::Tick_State(_float fTimeDelta)
{
    Input(fTimeDelta);
}

void CState_Engineer_Battle_Walk::Exit_State()
{

}

void CState_Engineer_Battle_Walk::Input(_float fTimeDelta)
{
...
CState_Engineer_Battle_Walk* CState_Engineer_Battle_Walk::Create(CStateMachine* pStateMachine, const list<wstring>& AnimationList)
{
    CState_Engineer_Battle_Walk* pInstance = new CState_Engineer_Battle_Walk(pStateMachine);

    if (FAILED(pInstance->Initialize(AnimationList)))
    {
        MSG_BOX("Fail Create : CState_Engineer_Battle_Walk");
...
void CState_Engineer_Battle_Walk::Free()
{
    __super::Free();
}
