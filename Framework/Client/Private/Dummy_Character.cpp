...
USING(Client)
CDummy_Character::CDummy_Character(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strObjectTag, CHARACTER_TYPE eCharacterType)
	: CGameObject(pDevice, pContext, strObjectTag, OBJ_TYPE::OBJ_CHARACTER)
{
	m_eCharacterType = eCharacterType;
}

CDummy_Character::CDummy_Character(const CDummy_Character& rhs)
	: CGameObject(rhs)
...
HRESULT CDummy_Character::Initialize_Prototype()
{
...
HRESULT CDummy_Character::Initialize(void* pArg)
{
...
void CDummy_Character::Tick(_float fTimeDelta)
{
...
void CDummy_Character::LateTick(_float fTimeDelta)
{
...
HRESULT CDummy_Character::Render()
{
	__super::Render();
...
HRESULT CDummy_Character::Render_ShadowDepth()
{
...
void CDummy_Character::Collision_Enter(const COLLISION_INFO& tInfo)
{
...
void CDummy_Character::Collision_Continue(const COLLISION_INFO& tInfo)
{

}

void CDummy_Character::Collision_Exit(const COLLISION_INFO& tInfo)
{
	
}


CHierarchyNode* CDummy_Character::Get_Socket(PARTTYPE eType)
{
...
CHierarchyNode* CDummy_Character::Get_Socket(const wstring& strSocketName)
{
...
void CDummy_Character::Generate_Trail(SOCKET_TYPE eSocketType)
{
...
void CDummy_Character::Stop_Trail(SOCKET_TYPE eSocketType)
{
	if (eSocketType >= SOCKET_TYPE::SOCKET_END)
		return;
...
void CDummy_Character::Set_Infinite(_float fInfiniteTime, _bool bInfinite)
{
...
void CDummy_Character::On_Damaged(const COLLISION_INFO& tInfo)
{

}


void CDummy_Character::Free()
{
	__super::Free();
