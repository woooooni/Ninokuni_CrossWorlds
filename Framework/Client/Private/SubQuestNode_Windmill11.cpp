...
HRESULT CSubQuestNode_Windmill11::Initialize()
{
	...
	Json Load = GI->Json_Load(L"../Bin/DataFiles/Quest/SubQuest/02. SubQuest02_Verde_WindmillRepair/SubQuest_Windmill11.json");
...
void CSubQuestNode_Windmill11::TalkEvent()
{
