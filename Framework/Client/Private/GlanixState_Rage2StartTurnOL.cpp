...
CGlanixState_Rage2StartTurnOL::CGlanixState_Rage2StartTurnOL(CStateMachine* pStateMachine)
	: CGlanixState_Base(pStateMachine)
{
}

HRESULT CGlanixState_Rage2StartTurnOL::Initialize(const list<wstring>& AnimationList)
{
...
void CGlanixState_Rage2StartTurnOL::Enter_State(void* pArg)
{
...
void CGlanixState_Rage2StartTurnOL::Tick_State(_float fTimeDelta)
{
	...
	{
		m_pStateMachineCom->Change_State(CGlanix::GLANIX_RAGE2START);
	}
}

void CGlanixState_Rage2StartTurnOL::Exit_State()
{
}

CGlanixState_Rage2StartTurnOL* CGlanixState_Rage2StartTurnOL::Create(CStateMachine* pStateMachine, const list<wstring>& AnimationList)
{
	CGlanixState_Rage2StartTurnOL* pInstance = new CGlanixState_Rage2StartTurnOL(pStateMachine);

	if (FAILED(pInstance->Initialize(AnimationList)))
	{
		MSG_BOX("Fail Create : CGlanixState_Rage2StartTurnOL");
...
void CGlanixState_Rage2StartTurnOL::Free()
{
	__super::Free();
}
