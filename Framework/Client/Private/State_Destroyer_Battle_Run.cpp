...
CState_Destroyer_Battle_Run::CState_Destroyer_Battle_Run(CStateMachine* pMachine)
    : CState_Character(pMachine)
{
}

HRESULT CState_Destroyer_Battle_Run::Initialize(const list<wstring>& AnimationList)
{
...
void CState_Destroyer_Battle_Run::Enter_State(void* pArg)
{
	m_pCharacter->Appear_Weapon();
	m_pModelCom->Set_Animation(m_AnimIndices[0]);
}

void CState_Destroyer_Battle_Run::Tick_State(_float fTimeDelta)
{
	Input(fTimeDelta);
}

void CState_Destroyer_Battle_Run::Exit_State()
{

}

void CState_Destroyer_Battle_Run::Input(_float fTimeDelta)
{
...
CState_Destroyer_Battle_Run* CState_Destroyer_Battle_Run::Create(CStateMachine* pStateMachine, const list<wstring>& AnimationList)
{
    CState_Destroyer_Battle_Run* pInstance = new CState_Destroyer_Battle_Run(pStateMachine);

    if (FAILED(pInstance->Initialize(AnimationList)))
    {
        MSG_BOX("Fail Create : CState_Destroyer_Battle_Run");
...
void CState_Destroyer_Battle_Run::Free()
{
    __super::Free();
}
