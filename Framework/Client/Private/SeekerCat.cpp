...
HRESULT CSeekerCat::Initialize(void* pArg)
{
	...
	m_pModelCom->Set_Animation(TEXT("SKM_SeekerCat.ao|SeekerCat_Stand"));
...
HRESULT CSeekerCat::Ready_Components()
{
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_SeekerCat"), TEXT("Com_Model"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
