...
HRESULT CBaobam_WaterNode_Blow::Initialize_Prototype(BTNODE_DESC* pDesc, CBehaviorTree* pBT)
{
...
CBaobam_WaterNode_Blow* CBaobam_WaterNode_Blow::Create(BTNODE_DESC* pDesc, CBehaviorTree* pBT)
{
