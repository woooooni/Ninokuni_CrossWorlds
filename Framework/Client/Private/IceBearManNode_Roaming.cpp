...
HRESULT CIceBearManNode_Roaming::Initialize_Prototype(BTNODE_DESC* pDesc, CBehaviorTree* pBT, vector<_vector>* vecRoamingArea)
{
...
{
	m_tBTNodeDesc.pOwnerModel->Set_Animation(TEXT("SKM_IceBearMan_Water.ao|IceBearMan_BattleWalk"));
	m_bIsRoaming = true;
}
...
CIceBearManNode_Roaming* CIceBearManNode_Roaming::Create(BTNODE_DESC* pDesc, CBehaviorTree* pBT, vector<_vector>* vecRoamingArea)
{
