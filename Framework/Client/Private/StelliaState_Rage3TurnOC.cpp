...
CStelliaState_Rage3TurnOC::CStelliaState_Rage3TurnOC(CStateMachine* pStateMachine)
	: CStelliaState_Base(pStateMachine)
{
}

HRESULT CStelliaState_Rage3TurnOC::Initialize(const list<wstring>& AnimationList)
{
...
void CStelliaState_Rage3TurnOC::Enter_State(void* pArg)
{
...
void CStelliaState_Rage3TurnOC::Tick_State(_float fTimeDelta)
{
...
void CStelliaState_Rage3TurnOC::Exit_State()
{
}

CStelliaState_Rage3TurnOC* CStelliaState_Rage3TurnOC::Create(CStateMachine* pStateMachine, const list<wstring>& AnimationList)
{
	CStelliaState_Rage3TurnOC* pInstance = new CStelliaState_Rage3TurnOC(pStateMachine);

	if (FAILED(pInstance->Initialize(AnimationList)))
	{
		MSG_BOX("Fail Create : CStelliaState_Rage3TurnOC");
...
void CStelliaState_Rage3TurnOC::Free()
{
	__super::Free();
}
