...
CLargeGrass::CLargeGrass(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strObjectTag)
	: CGameObject(pDevice, pContext, strObjectTag, OBJ_TYPE::OBJ_GRASS)
{
}

CLargeGrass::CLargeGrass(const CLargeGrass& rhs)
	: CGameObject(rhs)
{
}

HRESULT CLargeGrass::Initialize_Prototype()
{
	return S_OK;
}

HRESULT CLargeGrass::Initialize(void* pArg)
{
...
void CLargeGrass::Tick(_float fTimeDelta)
{
...
void CLargeGrass::LateTick(_float fTimeDelta)
{
...
HRESULT CLargeGrass::Render_Instance(CShader* pInstancingShader, CVIBuffer_Instancing* pInstancingBuffer, const vector<_float4x4>& WorldMatrices)
{
...
HRESULT CLargeGrass::Ready_Components()
{
	/* For.Com_Renderer */
...
HRESULT CLargeGrass::Bind_ShaderResource()
{
...
CLargeGrass* CLargeGrass::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strObjectTag)
{
	CLargeGrass* pInstance = new CLargeGrass(pDevice, pContext, strObjectTag);
	if (FAILED(pInstance->Initialize_Prototype()))
	{
		MSG_BOX("Failed to Created : CLargeGrass");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject* CLargeGrass::Clone(void* pArg)
{
	CLargeGrass* pInstance = new CLargeGrass(*this);
