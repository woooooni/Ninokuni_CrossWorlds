...
CNpcDMWState_Rage3Laser::CNpcDMWState_Rage3Laser(CStateMachine* pStateMachine)
	: CNpcDMWState_Base(pStateMachine)
{
}

HRESULT CNpcDMWState_Rage3Laser::Initialize(const list<wstring>& AnimationList)
{
...
void CNpcDMWState_Rage3Laser::Enter_State(void* pArg)
{
...
void CNpcDMWState_Rage3Laser::Tick_State(_float fTimeDelta)
{
...
void CNpcDMWState_Rage3Laser::Exit_State()
{
}

CNpcDMWState_Rage3Laser* CNpcDMWState_Rage3Laser::Create(CStateMachine* pStateMachine, const list<wstring>& AnimationList)
{
	CNpcDMWState_Rage3Laser* pInstance = new CNpcDMWState_Rage3Laser(pStateMachine);

	if (FAILED(pInstance->Initialize(AnimationList)))
	{
		MSG_BOX("Fail Create : CNpcDMWState_Rage3Laser");
...
void CNpcDMWState_Rage3Laser::Free()
{
	__super::Free();
}
