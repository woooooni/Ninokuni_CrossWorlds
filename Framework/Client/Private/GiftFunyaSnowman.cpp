...
HRESULT CGiftFunyaSnowman::Initialize(void* pArg)
{
	...
	m_pModelCom->Set_Animation(TEXT("SKM_GiftFunyaSnowman.ao|FunyaSnowman_Run"));
...
HRESULT CGiftFunyaSnowman::Render()
{
...
HRESULT CGiftFunyaSnowman::Ready_Components()
{
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Model_GiftFunyaSnowman"), TEXT("Com_Model"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
