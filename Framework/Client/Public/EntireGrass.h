...
class CEntireGrass final : public CGameObject
{
private:
...
private:
	explicit CEntireGrass(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strObjectTag);
	explicit CEntireGrass(const CEntireGrass& rhs);
	virtual ~CEntireGrass() = default;
...
private:
	...
	_float m_fTime = 0.0f;
private:
	Vec4 m_vUpperColor = Vec4(0.627f, 0.412f, 0.89f, 1.0f);
	Vec4 m_vBottomColor = Vec4(0.325f, 0.188f, 0.49f, 1.0f);

	//Vec4 m_vUpperColor = Vec4(0.412f, 0.549f, 0.282f, 1.0f);
	//Vec4 m_vBottomColor = Vec4(0.243f, 0.329f, 0.161f, 1.0f);
public:
	static CEntireGrass* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strObjectTag);
