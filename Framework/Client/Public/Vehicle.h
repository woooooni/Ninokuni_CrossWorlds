...
public:
	enum VEHICLE_STATE {
		...
		// 미니게임용 상태 (엔지니어)
		VEHICLE_ENGINEER_STAND,
		VEHICLE_ENGINEER_RUN,
		VEHICLE_ENGINEER_RUNAWAY,
		VEHICLE_ENGINEER_TRACE,
		VEHICLE_ENGINEER_ATTACK,
		VEHICLE_ENGINEER_SKILL_0,
		VEHICLE_ENGINEER_SKILL_1,
		VEHICLE_ENGINEER_SKILL_2,
		VEHICLE_ENGINEER_FINISH_ATTACK,
		VEHICLE_ENGINEER_DEAD,
