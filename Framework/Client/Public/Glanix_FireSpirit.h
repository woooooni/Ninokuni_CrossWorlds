...
BEGIN(Client)
class CGlanix_FireSpirit final : public CGameObject
{
private:
	CGlanix_FireSpirit(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strObjectTag);
	CGlanix_FireSpirit(const CGlanix_FireSpirit& rhs);
	virtual ~CGlanix_FireSpirit() = default;
...
public:
	static CGlanix_FireSpirit* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strObjectTag);
