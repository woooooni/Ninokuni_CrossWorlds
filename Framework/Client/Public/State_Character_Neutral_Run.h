...
class CState_Character_Neutral_Run : public CState_Character
{

private:
	CState_Character_Neutral_Run(class CStateMachine* pMachine);
	~CState_Character_Neutral_Run() = default;
