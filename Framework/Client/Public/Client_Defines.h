...
namespace Client
{
	...
	enum TRIGGER_TYPE { TRIGGER_CHANGE_BGM, TRIGGER_MAP_NAME, TRIGGER_BOSS_GIANTY_ENTER, TRIGGER_BOSS_STELLIA_ENTER, TRIGGER_WHALE_ENTER, TRIGGER_WITCH_WOOD_ENTER, TRIGGER_END };
