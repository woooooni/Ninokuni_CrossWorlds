...
namespace Client
{
	...
	enum SKILL_TYPE { SWORDMAN_PERFECT_BLADE, SWORDMAN_SIPOHONINGLUNGE, SWORDMAN_SPINNING_ASSAULT, SWORDMAN_BURST_MEGA_SLASH,
		ENGINEER_ELEMENTAL_BLAST, ENGINEER_EXPLOSIONSHOT, ENGINEER_BURSTCALL, ENGINNER_BURST_DESTRUCTION,
		DESTROYER_BRUTALSTRIKE, DESTROYER_LEAFSLAM ,DESTROYER_WHEELWIND, DESTROYER_BURST_HYPERSTRIKE,
