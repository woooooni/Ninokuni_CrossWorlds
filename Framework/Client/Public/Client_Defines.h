...
namespace Client
{
	...
	enum SKILL_TYPE { SWORDMAN_PERFECT_BLADE, SWORDMAN_SIPOHONINGLUNGE, SWORDMAN_SPINNING_ASSAULT, 
		ENGINEER_ELEMENTAL_BLAST, ENGINEER_EXPLOSIONSHOT, ENGINEER_BURSTCALL, 
		DESTROYER_BRUTALSTRIKE, DESTROYER_LEAFSLAM ,DESTROYER_WHEELWIND, SKILL_END
	};
