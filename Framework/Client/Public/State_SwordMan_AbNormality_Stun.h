...
class CState_SwordMan_AbNormality_Stun : public CState_Character
{

private:
	CState_SwordMan_AbNormality_Stun(class CStateMachine* pMachine);
	~CState_SwordMan_AbNormality_Stun() = default;
