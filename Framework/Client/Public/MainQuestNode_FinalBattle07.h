...
class CMainQuestNode_FinalBattle07 final : public CQuestNode_Base
{
private:
	CMainQuestNode_FinalBattle07();
	virtual ~CMainQuestNode_FinalBattle07() = default;
...
private:
	...
	_bool m_bIsRage3Talk = false;

	_bool m_bIsTalk = false;

public:
	static CMainQuestNode_FinalBattle07* Create();
