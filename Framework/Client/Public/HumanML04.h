...
class CHumanML04 final : public CGameNpc
{
private:
	CHumanML04(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strObjectTag);
	CHumanML04(const CHumanML04& rhs);
	virtual ~CHumanML04() = default;
