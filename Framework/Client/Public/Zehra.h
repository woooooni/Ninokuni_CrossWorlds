...
class CZehra final : public CGameNpc
{
private:
	CZehra(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strObjectTag);
	CZehra(const CZehra& rhs);
	virtual ~CZehra() = default;
