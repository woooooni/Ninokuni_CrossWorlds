...
public:
	enum NPC_STATE { NPC_IDLE, NPC_TALK, NPC_MOVE_ONEWAY, NPC_MOVE_TWOWAY,
		NPC_UNIQUENPC_WALK, NPC_UNIQUENPC_RUN, NPC_UNIQUENPC_TALK, NPC_BACKDOWN, NPC_FRONTDOWN, NPC_ATTACK_IDLE, NPC_ATTACK, NPC_UNIQUENPC_SEAT, NPC_UNIQUENPC_ATTACK, NPC_END };
