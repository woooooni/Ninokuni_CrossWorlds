...
BEGIN(Client)
class CTrail;
class CDummy_Character abstract : public CGameObject
{
...
protected:
	CDummy_Character(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strObjectTag, CHARACTER_TYPE eCharacterType);
	CDummy_Character(const CDummy_Character& rhs);
	virtual ~CDummy_Character() = default;
