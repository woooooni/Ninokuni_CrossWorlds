...
HRESULT CCollision_Manager::Reserve_Manager()
{
	...
	Reserve_CheckGroup(COLLISION_GROUP::CHARACTER, COLLISION_GROUP::PORTAL);
	...
	Reserve_CheckGroup(COLLISION_GROUP::CHARACTER, COLLISION_GROUP::CURLINGGAME_PROP);
	...
	Reserve_CheckGroup(COLLISION_GROUP::CURLINGGAME_PROP, COLLISION_GROUP::CURLINGGAME_PROP);
	Reserve_CheckGroup(COLLISION_GROUP::DEFENCE_TOWER, COLLISION_GROUP::TRIGGER);

	Reserve_CheckGroup(COLLISION_GROUP::CHARACTER, COLLISION_GROUP::RESPAWN);
	Reserve_CheckGroup(COLLISION_GROUP::NPC, COLLISION_GROUP::RESPAWN);
	Reserve_CheckGroup(COLLISION_GROUP::MONSTER, COLLISION_GROUP::RESPAWN);

	Reserve_CheckGroup(COLLISION_GROUP::PLANE_BODY, COLLISION_GROUP::PLANE_PROJECTILE);
	Reserve_CheckGroup(COLLISION_GROUP::PLANE_BODY, COLLISION_GROUP::PLANE_ITEM);
	Reserve_CheckGroup(COLLISION_GROUP::PLANEENEMY_BODY, COLLISION_GROUP::PLANE_PROJECTILE);

	Reserve_CheckGroup(COLLISION_GROUP::PLANEENEMY_BODY, COLLISION_GROUP::PLANE_BODY);
