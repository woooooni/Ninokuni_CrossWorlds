	...
	*/
	...
	public:
		...
		*/
		...
		in the provided parameter. The std::function will return XML_SUCCESS on success,
	...
	*/
	...
	public:
		...
		*/
		...
		/** Convenience std::function for easy access to the text inside an element. Although easy
		...
		Note that this std::function can be misleading. If the element foo was created from
		this XML:
		@verbatim
	...
	*/
	...
	public:
		...
		*/
		...
		/// A (trivial) utility std::function that prints the ErrorStr() to stdout.
